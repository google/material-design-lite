...
<CodeBlock lang="html" code={`<i class="material-icons">add</i>`} />
...
<CodeBlock lang="html" code={`<i class="material-symbols-rounded">add</i>`} />
...
<CodeBlock lang="html" code={`<i class="material-symbols-sharp">add</i>`} />
...
<CodeBlock lang="html" code={`<i class="material-symbols-outlined">add</i>`} />
